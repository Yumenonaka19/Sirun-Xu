<!--
// written by:Lulu Jiang Shengming Liang
// assisted by: Yu Xuan
		...
		<div class="container" role="main">
			...
			<div class="content">
				...
				<div class="page-header">
					<h1><span class="icon-signal"></span> Figure</h1>
					<br>
					<br>
					<br>
					<div class="button" >
				...
				<div class="page-container tab-content">
					...
					<!-- Tab #flot -->
					<div class="tab-pane" id="flot">
						
						<!-- Grid row -->
						<div class="row">
					
							<!-- Example jQuery Flot -->
							<!-- Page grid cell (5 blocks) -->
							<article class="span5">
								...
								<p>The plugin works with Internet Explorer 6+, Firefox 2.x+, Safari 3.0+, Opera 9.5+ and Konqueror 4.x+ with the HTML canvas tag (the excanvas Javascript emulation helper is used for IE < /></p>
								<p>More Flot Chart <a href="http://people.iola.dk/olau/flot/examples/" target="_blank">examples</a>.</p>
								
							</article>
							<!-- /Page grid cell (5 blocks) -->
							
							<!-- Page grid cell (7 blocks) -->
							<article class="span7">
							
								<div id="demo-1" class="flot wide"></div>
...
<?php 
    ...
    <!-- Main content wrapper -->
     <div class="wrappers">
			...
			<script>
	 window.open("Historical_Chart.php");
	</script>
